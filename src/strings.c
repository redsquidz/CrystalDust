...
const u8 gText_FreshWaterAndPrice[] = _("FRESH WATER{CLEAR_TO 0x57}{FONT SMALL}¥2.00");
const u8 gText_SodaPopAndPrice[] = _("SODA POP{CLEAR_TO 0x57}{FONT SMALL}¥3.00");
const u8 gText_LemonadeAndPrice[] = _("LEMONADE{CLEAR_TO 0x57}{FONT SMALL}¥3.50");
...
const u8 gText_50CoinsAndPrice[] = _("{FONT SMALL} 50 COINS{CLEAR_TO 0x45}¥10.00");
const u8 gText_500CoinsAndPrice[] = _("{FONT SMALL}500 COINS{CLEAR_TO 0x40}¥100.00");
